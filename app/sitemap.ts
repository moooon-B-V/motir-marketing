 ...
 * is reusable here.
 *
 * ⚠️ ONE ENTRY, AND THAT IS THE HONEST ANSWER. motir.co is one page today
 * (`app/page.tsx`) — the landing's own footer deliberately omits Product,
 * Pricing, Blog and About because those pages do not exist
 * (`design/marketing/design-notes.md`). A sitemap listing URLs that 404 is
 * worse than a short one. When a second page lands it adds its line here, in
